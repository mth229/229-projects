...
# ╔═╡ 345e966b-1050-42f3-880c-3ee5a83e8e41
begin
	# startup commands
...
function unzip(f::Function, a, b)
	...
	md"""replicating `MTH229` w/o `SymPy`"""
end

# ╔═╡ a425a7e9-f81c-40cd-998a-2f41d56c6e13
begin
...
function plotly_config(x,y=nothing;
	...
	md"""Replicating `Plots` using `PlotlyLight`."""

end


# ╔═╡ 196db932-ab38-11ee-3522-b5e993e65fe5
md"""
Basic Pluto.jl notebook withs some pre-loaded features.

* Adds some MTH229 functions (`tangent`,`secant`,`bisection`,`newton`,`sign_chart`,`lim`,`riemann`)
* Loads `PlotlyLight` and overrides `Plot` and `Plot!` to make simple plots.
* `SymPy` is not available here, but `@symbolic x [p]` can be used to create simple symbolic expressions; useful where functions are expected

----
"""

# ╔═╡ 66b1ef26-e45f-476b-ac9b-e6a12e7bb84b


# ╔═╡ 4d3a7d87-b62c-4680-a93b-17e16ded03cc


# ╔═╡ 6f088d8d-8271-42e1-ba05-569cb2864c4a


# ╔═╡ f00ddc3a-66bb-4347-a537-1e1fcafde82b


# ╔═╡ 8743f105-cc3f-4fa3-bfd9-544b21e31ae5


# ╔═╡ b26024b9-822b-47bd-8ff9-1586f8a3b538


# ╔═╡ 39fa0ed4-7bf9-457d-8667-6efa31882092


# ╔═╡ fc19fdd8-aab7-44e3-9007-710f6ed5c80e


# ╔═╡ 144e8d84-5acc-4de8-9f31-260bb3c6f6f3


# ╔═╡ ebd6ea0e-7955-42a5-8dcf-240cdcd7bd51


# ╔═╡ e25d1b7c-a9f9-4fb6-b836-fa9ed62e5ba3


# ╔═╡ 448f2e5a-09a3-44e0-a13a-7d1dffef45cd


# ╔═╡ 855192b3-f6d1-49b4-b403-ec7193767825
md"""----"""

# ╔═╡ c5da064d-6c94-4143-b8b2-be3e7e3b174e
begin
    # using SimpleExpressions.jl
end
...
manifest_format = "2.0"
project_hash = "d4e589fc87349bdb3dabd86da406f3c3610c5769"
